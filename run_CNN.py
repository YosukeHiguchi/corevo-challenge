...
import CNN.net as net
from CNN.updater import CNNUpdater
from CNN.evaluator import CNNEvaluator
...
def train():
    ...
    parser.add_argument('--feature', '-f', type=str, default='mfcc',
                ...
                help='feature type')
    parser.add_argument('--out', '-o', type=str, default='CNN/model/test',
...
def predict():
    ...
    parser.add_argument('--feature', '-f', type=str, default='mfcc',
                #choices=['mfcc', 'mfcc_delta', 'fbank', 'fbank_delta', 'plp', 'plp_delta'],
                help='feature type')
    parser.add_argument('--out', '-o', type=str, default='CNN/result/test',
                help='path to the output directory')
    parser.add_argument('--seed', type=int, default=0,
                help='random seed')
    args = parser.parse_args()
